...
"""
Create cleaned CSV from Gemini Lucknow predictions
...
INPUT_CSV = Path(
    ...
    "gemini-3m-pro_kiln_lucknow_only.csv"
)

OUTPUT_CSV = Path(
    "/home/rishabh.mondal/Brick-Kilns-project/ijcai_2025_kilns/temporal-analysis/"
    "model_prediction_csv/gemini_kiln_stats_lucknow_cleaned.csv"
)

# Create output directory if it doesn't exist
OUTPUT_CSV.parent.mkdir(parents=True, exist_ok=True)

# Read the Gemini Lucknow predictions
