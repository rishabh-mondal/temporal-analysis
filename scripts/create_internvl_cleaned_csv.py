...
"""
Create cleaned CSV from InternVL predictions
...
INPUT_CSV = Path(
    ...
    "internvl3_5_38b_kiln_change_results_delhi_all_loc_bbox.csv"
)

OUTPUT_CSV = Path(
    "/home/rishabh.mondal/Brick-Kilns-project/ijcai_2025_kilns/temporal-analysis/"
    "model_prediction_csv/internvl_kiln_stats_delhi_all_loc_cleaned.csv"
)

# Create output directory if it doesn't exist
OUTPUT_CSV.parent.mkdir(parents=True, exist_ok=True)

# Read the InternVL predictions
...
print(cleaned_df[cleaned_df['shape_transition_year_after'] > 0]['shape_transition_year_after'].value_counts().sort_index())
