...
"""
Create cleaned CSV from GPT-5 Lucknow predictions
...
INPUT_CSV = Path(
    ...
    "gpt5_kiln_change_results_lucknow_all_loc_bbox.csv"
)

OUTPUT_CSV = Path(
    "/home/rishabh.mondal/Brick-Kilns-project/ijcai_2025_kilns/temporal-analysis/"
    "model_prediction_csv/gpt5_kiln_stats_lucknow_cleaned.csv"
)

# Create output directory if it doesn't exist
OUTPUT_CSV.parent.mkdir(parents=True, exist_ok=True)

# Read the GPT-5 Lucknow predictions
